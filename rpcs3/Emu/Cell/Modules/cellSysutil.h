...
enum
{
	...
	// guessing with these
	CELL_SYSUTIL_ERROR_NO_PACKET_FOR_EVENT = 0x8002B001,
	CELL_SYSUTIL_ERROR_INVALID_PACKET_SLOT = 0x8002B002,
	CELL_SYSUTIL_ERROR_UNK_ERROR2 = 0x8002B006,
	CELL_SYSUTIL_ERROR_UNK_ERROR = 0x8002B007,

	CELL_SYSUTIL_CXML_INVALID_BUFFER_SIZE = 0x8002E002,
	CELL_SYSUTIL_CXML_INVALID_OFFSET = 0x8002E004,
	CELL_SYSUTIL_CXML_ALLOCATION_ERROR = 0x8002E005,
	CELL_SYSUTIL_CXML_INVALID_TABLE = 0x8002E006,
	CELL_SYSUTIL_CXML_INVALID_VERSION = 0x8002E007,
	CELL_SYSUTIL_CXML_INVALID_DOC = 0x8002E008,
	CELL_SYSUTIL_CXML_INVALID_ACCESS_MODE = 0x8002E010,
	CELL_SYSUTIL_CXML_ELEMENT_CANT_FIND_ATTRIBUTE = 0x8002E011,
	CELL_SYSUTIL_CXML_ELEMENT_INVALID_ATTRIBUTE_NUM = 0x8002E012,
	CELL_SYSUTIL_CXML_ELEMENT_INVALID_OFFSET = 0x8002E013,
	CELL_SYSUTIL_CXML_NO_ALLOCATOR = 0x8002E014,
};
...
enum CellSysutilSharedMemoryPoolType
{
	SYSUTIL_SHARED_MEMORY_POOL_64KB = 0,
	SYSUTIL_SHARED_MEMORY_POOL_1MB = 1
};

struct CellSysutilSharedMemoryPoolInformation
{
	u32 allocation;
	u32 count;
};
